...
alias ccwa='cc -Wall -Wextra -Werror -fsanitize=address -g'
alias format='yes y | python3 -m c_formatter_42 -c'
alias normrc='norminette -R CheckForbiddenSourceHeader'
alias ccw='cc -Wall -Wextra -Werror *.c && ./a.out'
alias check='find . -name "*.c" | grep -v main | xargs norminette'
